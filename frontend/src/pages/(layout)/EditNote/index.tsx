    ...
    >
      <div className="relative flex h-96 w-1/3 items-center bg-myLightGray opacity-100">
        ...
        <div className="mx-4 flex h-full w-full flex-col py-4">
          <input
            type="text"
            className="mb-1 h-8 w-full rounded-md
            border-2 p-3 font-nunitoRegular focus:outline-none"
          ...
          />
          <div
            className="relative mb-1 flex h-8 w-full flex-row items-center rounded-md
            border-2 bg-white"
          >
            <div
